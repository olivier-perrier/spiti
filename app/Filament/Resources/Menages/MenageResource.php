...
use App\Filament\Resources\Menages\RelationManagers\ProceduresRelationManager;
use App\Filament\Resources\Menages\RelationManagers\ResourcesRelationManager;
...
class MenageResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                Grid::make(3)->schema([
                    Section::make('Informations sur le ménage')->schema([
                    ...
                    Section::make('Orientation')->schema([
                        DatePicker::make('date_orientation')->label("Date d'orientation"),
                        Select::make('oriented_by')->label('Orienté par')
                            ->options([
                                'naissance' => 'Naissance',
                                'SIAO' => 'SIAO',
                                'local_OFII' => 'OFII local',
                    ...
                    Section::make('Répprochement familiale')->schema([
                        Select::make('familial_reunion')->label('Rapprochement familial')
                            ->options([
                                'none' => 'Aucun',
                                'future' => 'A prévoir',
                                'done' => 'Effectué',
                        ...
                        TextInput::make('precision')->label('Précision'),

                    ]),
                    Group::make([
                        Section::make('Domiciliation')
