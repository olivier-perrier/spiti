...
class ResidencesRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Résidences associées';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                TextColumn::make('name')->sortable()->label('Résidence'),
                ...
                TextColumn::make('responsable.name')->label('Responsable')->sortable(),
            ])
            ->filters([
                //
            ])
